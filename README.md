...
초안 작성 중 | 작성일 2026년 4월 25일 | 수정일 2026년 4월 27일
...
이 책의 초안을 다시 읽으며 특히 의식한 독자는 연구자보다 먼저 삶의 자리에서 이 내용을 만나는 사람들이다. 최근 진단을 받은 아이의 부모, 성인이 되어 진단받은 자폐 당사자, 말로 의사소통하기 어려운 당사자, 첫 아이를 기다리는 예비 부모, 형제자매와 조부모, 특수교육 교사와 통합학급 교사가 이 책의 문장을 서로 다르게 읽을 것이다. 같은 유전율이라는 숫자도 부모에게는 죄책감으로, 예비 부모에게는 불안으로, 당사자에게는 자기 설명의 언어로, 교사에게는 지원 계획의 단서로 다가갈 수 있다. 그래서 이 책은 과학적 사실을 가능한 한 정확히 설명하되, 그 사실이 사람을 탓하거나 미래를 단정하거나 자폐를 한 방향의 가치 판단으로만 말하는 방식으로 쓰이지 않도록 경계한다. 각 장의 마지막에는 그 장의 연구 결과가 실제 삶으로 옮겨질 때 붙잡아야 할 질문을 덧붙였다.

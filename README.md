...
이 발전은 소수의 천재가 이끈 것이 아니다. 지난 20년 동안 수만 가족이 자신의 유전체 정보를 연구에 기꺼이 제공했고, 수십 개 나라의 수백 개 연구팀이 데이터를 모으고 공유했다. SSC의 2,600가족, SPARK의 50만 명, MSSNG의 11,000명, 한국의 K-ARC까지, 코호트라는 이름의 대규모 협력이 없었다면 오늘날의 발견은 불가능했다. 이 책은 그 협력이 무엇을 밝혀냈는지를 전문가가 아닌 사람들도 이해할 수 있는 말로 풀어내려 한다. 연구에 참여한 가족들이 "내가 제공한 데이터로 과학이 무엇을 알아냈는지"를 이해할 수 있어야 한다고 생각하기 때문이다.

그래서 이 책은 유전학 교과서가 되지 않으려 했다. 머릿속에 두고 쓴 독자가 몇 사람 있었다. 한 사람은 자폐를 가진 아이의 부모다. 진료실에서 종이 한 장을 받아 돌아왔는데, 거기 적힌 낯선 유전자 이름과 변이 표기가 무엇을 뜻하는지 의사의 짧은 설명만으로는 다 짚을 수 없었던 부모. 그가 그 결과지를 다시 펼쳐놓을 때, 이 책이 그 옆에 앉아 한 줄씩 짚어줄 수 있기를 바랐다. 이 유전자가 시냅스에서 어떤 일을 하는지, 이 변이가 발견된다는 사실은 무엇을 뜻하는지, 지금 과학이 알아낸 것과 아직 모르는 것의 경계는 어디쯤인지를 차례로 풀어주는 책이기를 바랐다. 또 한 사람은 특수교육을 공부하는 학생이다. 학교와 가정에서 자폐를 가진 아이를 매일 마주하는 사람일수록, 그 아이의 행동 뒤에 어떤 생물학적 결이 있고 그에 대해 과학이 어디까지 답했는지를 알아두면 일상의 판단이 달라진다고 생각했다. 유전학에 막 관심이 생긴 고등학생도 떠올렸다. 첫 장을 펼쳤다가 낯선 용어 앞에서 책을 덮어버리는 일이 없도록, 전문 용어가 처음 등장할 때마다 그 자리에서 풀어 설명을 붙였고 가능한 곳에는 비유를 한 줄씩 끼워 넣었다. 다만 쉽게 쓴다는 것이 적당히 얼버무린다는 뜻이어서는 안 된다고 보았다. 정확함이 필요한 자리에서는 친절보다 정확함을 앞에 두었고, 과학의 정밀함은 끝까지 놓지 않으려 했다.

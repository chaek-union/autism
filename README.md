...
자폐스펙트럼장애의 유전학은 지난 20년 동안 어떤 의학 분야보다 빠르게 발전해왔다. 2007년에 신생 구조 변이가 자폐와 연관된다는 첫 번째 확고한 증거가 나온 이후, 수만 가족의 유전체가 읽히고, 185개의 위험 유전자가 확인되었으며, 유전자에서 세포로, 세포에서 회로로, 회로에서 치료 가능성으로 이어지는 경로가 하나씩 열리고 있다. 이 책은 그 여정의 기록이다.

...
유전자 발견의 역사는 표본 크기의 역사이기도 하다. 200가족에서는 SCN2A 하나를 겨우 확인할 수 있었지만, 6만 명을 모으니 185개의 유전자가 보이기 시작했다. 하지만 이 유전자들은 모두 단백질을 만드는 코딩 영역에서 발견된 것이고, 대부분 부모에게 없던 신생변이에 의해 확인된 것이다. 한 사람이 가진 400~500만 개의 유전 변이 중 신생변이는 60~80개에 불과하며, 나머지 99.98%는 부모에게서 물려받은 것이다. 다음 장에서는 이 유전된 변이, 특히 부모로부터 물려받은 희귀 변이가 자폐에 어떻게 기여하는지를 살펴본다.

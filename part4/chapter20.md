...
성차의 문제는 아직 풀리지 않았다. 여성 보호 효과가 존재한다는 것에 대한 분자적 증거는 강력하지만, 그 보호가 무엇인지, 어떤 분자적 기전으로 작동하는지는 아직 밝혀지지 않았다. 이것은 자폐 유전학에서 가장 활발하게 연구되는 영역 중 하나이며, 성별에 따른 후성유전체 차이, 면역 반응의 차이, 미세아교세포 기능의 차이 등이 후보 기전으로 탐구되고 있다.
